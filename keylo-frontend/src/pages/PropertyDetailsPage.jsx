...
export default function PropertyDetailsPage() {
  ...
  const propertyImages = [
    ...
    'https://lh3.googleusercontent.com/aida-public/AB6AXuC8GKTWhZscKHX2BQ9jwIFAZmQMk-l_30pDz4ZlKLdBtainDSghHKdmTf3Xkc5l96TvsXFgAgoEmYIYgxdnekCMnc7lAfDGLbFJRY7d3r5n9KHIoTYljUM8kkzIJbvLLWwvvKDJC690ZhctzIaNnrj_GCHjpuaipNpKddV5mu6TZOraZoS7gvR5LHsALn6N6rq2SEThFuBqXKFH60VzeLz9k-8oeWsPfd1Gdsn_5X0WwFUyu9oedEow',
        ...
        <div className="lg:col-span-8 flex flex-col gap-xl pb-xl">
          ...
          <div className="flex flex-col gap-md border-b-2 border-primary pb-lg relative">
            <div className="flex items-baseline gap-sm">
              ...
              <span className="px-sm py-xs bg-verified text-primary border-2 border-primary font-label-caps text-label-caps shadow-[2px_2px_0px_0px_#000000]">
                VERIFIED
              </span>
            </div>
            <h1 className="font-heading text-h1-mobile md:text-h1 text-primary font-bold">Urban Nest PG</h1>
            <div className="flex flex-wrap items-center gap-md font-body-md text-body-md text-on-surface-variant">
              ...
              <div className="flex items-center gap-xs">
                ...
                <span>0.6 km to Jadavpur University</span>
              </div>
            </div>
          </div>
          ...
          <section className="flex flex-col gap-md">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant">
              Experience premium student living in the heart of Jadavpur, Kolkata. Designed specifically for students and young professionals near Jadavpur University, Urban Nest offers a perfect balance of privacy for focus and community areas for socializing. High-speed Wi-Fi, daily housekeeping, and 24/7 security come standard.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-md">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-md">
              <div className="flex flex-col items-center justify-center p-md bg-surface-container border-2 border-primary rounded-xl shadow-[4px_4px_0px_0px_#000000] hover:-translate-y-1 transition-transform">
                <span className="material-symbols-outlined text-h2 mb-xs">wifi</span>
                <span className="font-label-caps text-label-caps text-center">Gigabit Wi-Fi</span>
              </div>
              <div className="flex flex-col items-center justify-center p-md bg-surface-container border-2 border-primary rounded-xl shadow-[4px_4px_0px_0px_#000000] hover:-translate-y-1 transition-transform">
                <span className="material-symbols-outlined text-h2 mb-xs">cleaning_services</span>
                <span className="font-label-caps text-label-caps text-center">Daily Housekeeping</span>
              </div>
              <div className="flex flex-col items-center justify-center p-md bg-surface-container border-2 border-primary rounded-xl shadow-[4px_4px_0px_0px_#000000] hover:-translate-y-1 transition-transform">
                <span className="material-symbols-outlined text-h2 mb-xs">local_laundry_service</span>
                <span className="font-label-caps text-label-caps text-center">In-house Laundry</span>
              </div>
              <div className="flex flex-col items-center justify-center p-md bg-surface-container border-2 border-primary rounded-xl shadow-[4px_4px_0px_0px_#000000] hover:-translate-y-1 transition-transform">
                <span className="material-symbols-outlined text-h2 mb-xs">security</span>
                <span className="font-label-caps text-label-caps text-center">24/7 Security</span>
              </div>
            </div>
          </section>
            ...
            <div className="flex flex-col gap-md">
              ...
              >
                ...
                <div className="flex flex-col items-start md:items-end w-full md:w-auto">
                  <span className="font-price-display text-price-display text-primary">₹8,500</span>
              ...
              >
                ...
                <div className="flex flex-col items-start md:items-end w-full md:w-auto">
                  <span className="font-price-display text-price-display text-primary line-through decoration-2">₹14,000</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-md border-t-2 border-primary pt-lg mt-lg">
            ...
            <div>
              ...
              <div
                ...
                data-location="Jadavpur, Kolkata"
                style={{
                  backgroundImage:
