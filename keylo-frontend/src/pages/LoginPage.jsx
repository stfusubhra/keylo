      ...
      <div className="w-full" style={{ maxWidth: '448px' }}>
        ...
        <div className="bg-surface border-2 border-primary shadow-[8px_8px_0px_0px_#000000] p-xl">
          ...
          <div className="grid grid-cols-2 gap-md">
            <button type="button" disabled={isLoading} className="py-md bg-surface text-primary font-label-caps text-label-caps border-2 border-primary hover:bg-acid-lime transition-all flex items-center justify-center gap-sm disabled:opacity-50">
